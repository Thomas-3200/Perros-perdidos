...
export default function ReportarAvistamientoPage() {
  ...
  /* ── Éxito ────────────────────────────────────────────────────────────── */
  if (done) {
    const cityForShare = city || 'tu zona';
    const shareText    = `🐾 Acabo de reportar un avistamiento en Perros Perdidos para ayudar a un perrito a volver a casa.\n\nSi viste algún perro perdido en ${cityForShare} o querés ayudar a buscar, sumate acá:\nhttps://perros-perdidos-web.vercel.app`;
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-12">
        <div className="text-center space-y-5 max-w-sm w-full">
          ...
          {/* Compartir — primario, alta visibilidad */}
